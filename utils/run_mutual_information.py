...
from generate_data import generate_correlated_data_sigma
import re
...
# Last inn data
X_train, X_test, y_train, y_test = generate_correlated_data_sigma(n=100, p=6, random_state=42, sigma=2.0)
N, p = X_train.shape
seed = 42
data_type = "mi"
config_name = f"mutual_information_N{N}_p{p}_sigma_{2.0}"
