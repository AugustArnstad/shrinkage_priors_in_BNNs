...
from generate_data import generate_latent_hastie_data
import re
...
# Last inn data
X_train, X_test, y_train, y_test = generate_latent_hastie_data(n=100, p=20, random_state=42)
N, p = X_train.shape
seed = 42
data_type = "hastie"
config_name = f"hastie_N{N}_p{p}"
